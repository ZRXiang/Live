...
import com.zrx.live.Like.HeartLayout;
import com.zrx.live.R;
import com.zrx.live.bean.Gift;
import com.zrx.live.customview.RoundImageView;
import com.zrx.live.gift.GiftPopwin;
import com.zrx.live.utils.DisplayUtil;
...
public class UiFragment extends Fragment {
    ...
    private void sendText() {
        if (!etInput.getText().toString().trim().isEmpty()) {
            messageData.add("北财: " + etInput.getText().toString().trim());
            etInput.setText("");
